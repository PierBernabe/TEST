% affichage de la r�ponse impulsionnelle et en fr�quence d'un filtre
% pour diff�rentes quantifications

%filtre 1 / 5eme ordre Cheby1 LP �  wc = 0.1* freq. Nyquist
...
% arrondir ici les coefficients b6 et a6
b61=[0.00001, 0.00001, 0.00005, 0.00010, 0.00005, 0.00001];
a61=[1, -4.58787, 8.53992, -8.05601, 3.84945, -0.74516];  


% ----------------------------------------------------------------

% filtre 2 :10eme ordre  Butterworth LP � wc =0.1 * freq. Nyquist  
%  <=> wc= 0.05 en freq normalis� par rapport � Fe...
...
% -------------------------------------------------------------
a=a61;    % initialisation des coeff IIR � utiliser
b=b61;
